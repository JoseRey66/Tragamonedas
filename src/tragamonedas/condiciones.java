...
public class condiciones {
    ...
    public boolean condicion6(int cartas1, int cartas2, int cartas3) {  //Cualquier par de numeros iguales mayores de 5 y menores de 11
    ...
    public boolean condicion7(int cartas1, int cartas2, int cartas3) {
        if ((cartas1 == 3 && cartas2 == 6 && cartas3 == 9) || (cartas1 == 9 && cartas2 == 3 && cartas3 == 6)
            || (cartas1 == 6 && cartas2 == 9 && cartas3 == 3)   ) {
